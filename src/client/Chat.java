...
public class Chat extends GUI {
    ...
    private final ArrayList<String> message_list;
    ...
    public Chat(Home home, Socket connection, String connection_info, String title) { 
        ...
        this.jl_title.setText("Talking to: " + connection_info.split(":")[0]);
    ...
    // updates text area when messages are received
    ...
    // when sending message to someone
    private void send() {
        DateFormat df = new SimpleDateFormat("hh:mm:ss");
        message_list.add("<b>[" + df.format(new Date()) + "] Me: </b><i>" + jt_message.getText() + "</i><br>");
